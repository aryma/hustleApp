...
function updateIcons(cordovaProject, platformResourcesDir) {
    ...
    var resourceMap = mapImageResources(cordovaProject.root, platformResourcesDir, 'mipmap', 'icon.jpg');
    ...
    for (var density in android_icons) {
        var targetPath = getImageResourcePath(
            platformResourcesDir, 'mipmap', density, 'icon.jpg', path.basename(android_icons[density].src));
    ...
    if (default_icon && !android_icons.mdpi) {
        var defaultTargetPath = getImageResourcePath(
            platformResourcesDir, 'mipmap', 'mdpi', 'icon.jpg', path.basename(default_icon.src));
...
function cleanIcons(projectRoot, projectConfig, platformResourcesDir) {
    ...
    if (icons.length > 0) {
        var resourceMap = mapImageResources(projectRoot, platformResourcesDir, 'mipmap', 'icon.jpg');
